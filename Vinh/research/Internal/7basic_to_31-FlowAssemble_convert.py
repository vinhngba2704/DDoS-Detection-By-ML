...
input_file = [
    f'{Path(__file__).parent}/updated_fw1.csv',
    f'{Path(__file__).parent}/updated_fw2.csv',
    f'{Path(__file__).parent}/updated_fw3.csv',
    f'{Path(__file__).parent}/updated_fw4.csv'
]

output_file = [
    f'{Path(__file__).parent}/extracted_flow_features_fw1.csv',
    f'{Path(__file__).parent}/extracted_flow_features_fw2.csv',
    f'{Path(__file__).parent}/extracted_flow_features_fw3.csv',
    f'{Path(__file__).parent}/extracted_flow_features_fw4.csv'
]
